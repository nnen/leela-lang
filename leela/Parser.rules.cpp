...
Ref<Object> Parser::parseLValue(Ref<Object> inherited, vector<Ref<Object> > siblings)
{
	...
	_nonterminals.push_back("LValue");
...
Ref<Object> Parser::parseMult(Ref<Object> inherited, vector<Ref<Object> > siblings)
{
	vector<Ref<Object> > match;
	Ref<Object> result;

	_nonterminals.push_back("Mult");

	switch (peek().type) {
	case Token::MINUS:
		match.push_back(accept(Token::MINUS).value);
		match.push_back(parseTerm(result, match));
		match.push_back(parseMultRest(result, match));
		break;
...
Ref<Object> Parser::parseExpression(Ref<Object> inherited, vector<Ref<Object> > siblings)
{
	...
	case Token::LEFT_PAR:
	case Token::STRING:
		match.push_back(parseMult(result, match));
...
Ref<Object> Parser::parseLValueRest(Ref<Object> inherited, vector<Ref<Object> > siblings)
{
	...
	_nonterminals.push_back("LValueRest");
...
Ref<Object> Parser::parseMultRest(Ref<Object> inherited, vector<Ref<Object> > siblings)
{
	vector<Ref<Object> > match;
	Ref<Object> result;

	_nonterminals.push_back("MultRest");
